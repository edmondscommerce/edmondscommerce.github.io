...
status: publish
published: true
title: Var_dump got you down? Collapse it, with jQuery!
author: admin
author_login: blogadmin
author_email: info@edmondscommerce.co.uk
author_url: http://www.edmondscommerce.co.uk
wordpress_id: 3205
wordpress_url: http://www.edmondscommerce.co.uk/?p=3205
date: 2012-08-01 09:50:01.000000000 +01:00
categories:
- php
tags:
- javascript
...
Kint is a collapsible jQuery-based var_dump that works really well, with a lot of configuration but works flawlessly out of the box.  Simply include the class file (using absolute paths is fine because you're not going to deploy this to a live server, right?), and start using it's static class methods... or their <em>really</em> short aliases :
...
Example output (wordpress may break the javascript, also available as an example at <a href="http://jsfiddle.net/NNfMW" title="http://jsfiddle.net/NNfMW">http://jsfiddle.net/NNfMW</a>/) :
